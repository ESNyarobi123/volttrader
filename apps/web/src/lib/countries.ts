/** ISO countries with dial codes — for register country/phone pickers. */
...
export const DEFAULT_COUNTRY_ISO = "TZ";
...
export const COUNTRIES: CountryOption[] = [
  ...
  { iso2: "HM", name: "Heard & McDonald Islands", dial: "+672" },
  ...
  { iso2: "GS", name: "South Georgia & South Sandwich Islands", dial: "+500" },
